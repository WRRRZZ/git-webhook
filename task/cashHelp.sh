...
# 调用脚本执行
echo -e "\n██获取到的ck：${cks}\n██助力给：${pins}" |ts >> ${scriptHomePath}/logs/cashHelp.log 2>&1&
export JD_COOKIE=${cks} && export cash_zlzh=${pins} && nohup python3 -u ${zjdHomePath}/jd_cashHelp.py |ts >> ${scriptHomePath}/logs/cashHelp.log 2>&1&